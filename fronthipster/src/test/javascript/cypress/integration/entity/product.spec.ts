...
describe('Product e2e test', () => {
  ...
  const productSample = { title: 'invoice leading-edge de' };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      ...
      cy.get(`[data-cy="keywords"]`).type('stable la').should('have.value', 'stable la');

      cy.get(`[data-cy="description"]`)
        .type('Buckinghamshire Bourgogne Visionary')
        .should('have.value', 'Buckinghamshire Bourgogne Visionary');
